...
public class LoginFragment extends Fragment {
    ...
    private void loginFragmentElements() {
        ...
        Signin = getView().findViewById(R.id.login_signinbtn);
        Signup = getView().findViewById(R.id.login_signupbtn);
    }
                ...
                if (username.isEmpty() || password.isEmpty()) {
                    ...
                    if (loginCursorCheck.getCount() > 0) {
                        ...
                        if (myCheck.getCount() > 0) {
                            ...
                            loginChange.putString("accountUserId", String.valueOf(account.getUsername()));
                            loginChange.putString("accountName", String.valueOf(account.getFullname()));
